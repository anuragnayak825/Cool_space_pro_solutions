...
export default function QuotationForm() {
  ...
  return (
    <form
      ...
      className="w-full max-w-xl mx-auto border border-gray-300 bg-white px-4 py-6 sm:px-6 md:px-8 rounded-md shadow-xl space-y-6"
    >
      ...
      <div className="relative w-full">
        <textarea
          ...
          required
          rows="4"
          className="peer w-full border-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-blue-600 rounded-md px-4 pt-5 resize-none"
