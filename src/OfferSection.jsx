            ...
            <div className='w-full lg:w-[35%] h-auto'>
                <div className='w-full h-full bg-blue-600 text-white px-6 md:px-10 lg:px-18 py-10'>
                    ...
                    <p
                        ...
                        className='text-base md:text-[20px] lg:text-[24px] mt-6 md:mt-10 leading-8 md:leading-10 tracking-wider font-semibold text-center'
                    >
            ...
            <div className='w-full lg:w-[60%] h-full mx-auto flex flex-col gap-4'>
                ...
                <div className='w-full relative overflow-hidden group'>
                    <img
                        ...
                        alt=""
                        className='w-full h-[40vh] md:h-[50vh] lg:h-[60vh] object-cover transform transition-transform duration-[3000ms] ease-in-out group-hover:scale-110 brightness-[1.15]'
                    />
