...
const installationData = [
    {
        ...
        addons: [
            ...
            { name: 'Wire Casing', price: 'RM 5/ft' },
        ],
    },
    {
        ...
        addons: [
            ...
            { name: '2x3 Casing', price: 'RM 19/ft' },
            { name: 'Wire Casing', price: 'RM 5/ft' },
        ],
    },
    {
    ...
    },
    {
        ...
        includes: ['Wires', 'Outdoor Bracket', "10' Copper Pipe", 'Drain Pipe'],
        addons: [
            { name: 'Switch', price: 'RM 125 each' },
            { name: 'Wires, Copper, Drain Pipe', price: 'RM 33/ft' },
            { name: 'Extra Wiring', price: 'RM 20/ft' },
            { name: '2x3 Casing', price: 'RM 15/ft' },
            { name: 'Wire Casing', price: 'RM 5/ft' },
        ],
    },
...
const Card = ({ title, price, includes, addons }) => (
    <motion.div
        ...
        className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-200 flex flex-col group"
    >
        {/* Gradient Header */}
...
const InstallationPricingCards2 = () => {
    return (
...
export default InstallationPricingCards2;
