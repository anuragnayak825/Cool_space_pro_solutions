        ...
        <Layout>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                        {services.map((item, index) => (
                            <div
                                key={index}
                                className="group relative border border-gray-200 shadow-md rounded-md  hover:shadow-xl transition duration-300"
                            >
                                {/* Image */}
                                <div className="relative w-full h-60 sm:h-64 lg:h-72 overflow-hidden">
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-[#00000194] bg-opacity-40 scale-0 group-hover:scale-100 transition-all duration-500 ease-in-out origin-top-left rounded-[200px] group-hover:rounded-none"></div>
                                </div>

                                {/* Content */}
                                <div className="relative bg-white p-6 pt-12 flex flex-col justify-between h-auto md:h-[250px]">
                                    {/* Floating Icon */}
            ...
            <section className='w-full h-auto bg-[#f8f8f8] flex flex-col-reverse lg:flex-row-reverse py-16'>
                <div className='w-full lg:w-1/2 h-full px-4 md:px-8'>
                    <h1 className='text-2xl md:text-5xl lg:text-6xl font-bold text-gray-700 md:mb-9 text-center lg:text-left'>Our Smooth & Simple Service Flow</h1>
                    <div className='w-full h-auto'>
                        {Service_Flow.map((item, i) => (
                            <div className='flex flex-col sm:flex-row justify-between border-b border-b-gray-400 py-5 pb-8 space-y-4 sm:space-y-0 sm:space-x-10' key={i}>
                                <div className='px-1.5 text-3xl font-bold text-[#00C4CC]'>0{item.id}</div>
                                <div>
                                    <h1 className='text-xl md:text-2xl font-semibold text-gray-700'>{item.title}</h1>
                ...
                <div className='w-full lg:w-1/2 h-auto px-4 md:px-10 py-10 lg:py-16 overflow-hidden'>
                    <div className='relative w-full max-w-full lg:max-w-[570px] mx-auto'>
                        <img src={Fow_baner} alt="" className='w-full rounded-lg' />
                        ...
                        <div className='absolute -bottom-24 sm:-bottom-36 md:-bottom-40 -right-4 sm:-right-8 md:-right-16 w-40 sm:w-52 md:w-64 border-4 md:border-8 border-[#f8f8f8]'>
                            <img src="https://templatekit.tokomoo.com/plumbingkit/wp-content/uploads/sites/60/2021/12/young-male-plumber-holding-pipe-wrench-on-a-constr-2021-10-14-23-13-34-utc-1.jpg" alt="" className='w-full object-cover rounded-md' />
